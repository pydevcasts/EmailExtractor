...
# ======================================================
    async def fetch(self,url):
        ...
        try:
            ...
            print(response, 0000000000000000)
            return response 
        except Exception as err:
            print(f"error goes to :{err}")
        

    async def search_phone_numbers(self,query,output_text):
        urls = [result for result in search(query, tld="co.in", num=30)] 
        print(urls, 2222222222222)
        ...
        for i, response in enumerate(responses):
            try:
                ...
                self.output_text.insert("0.0", f"Phone numbers for {domain}:\n" * 50)
